...
// write data
fs.writeFile("./quran-word-lists/lemmaData.json", JSON.stringify(sortedLemmaData), function (err) {
  if (err) throw err;
  console.log("./quran-word-lists/lemmaData.json");
});
// write data
fs.writeFile("./src/lemmaData.json", JSON.stringify(sortedLemmaData), function (err) {
  if (err) throw err;
  console.log("./src/lemmaData.json");
});
